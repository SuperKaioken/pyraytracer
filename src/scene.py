...
#    light1 = objects.Light(numpy.array([0, 50, -80]), numpy.array([1,1,1]), numpy.array([0.5,0.5,0.5]))
#    LIGHT_LIST.append(light1)

    # center, radius, color, spectral_color, shininess
    object1 = objects.Sphere(numpy.array([0, 0, -30]), 10, numpy.array([1.0, 0.0, 0.0]), numpy.array([0.8, 0.8, 0.8]), 32)
    ...
    # position, color, spectral_color
    light1 = objects.Light(numpy.array([15, 30, -20]), numpy.array([1,1,1]), numpy.array([0.5,0.5,0.5]))
    LIGHT_LIST.append(light1)
